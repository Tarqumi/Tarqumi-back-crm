...
class StoreBlogPostRequest extends FormRequest
{
    ...
    {
        return [
            'title_ar' => ['required', 'string', 'min:10', 'max:200', 'regex:/[\x{0600}-\x{06FF}]/u'],
            'title_en' => ['required', 'string', 'min:10', 'max:200', 'regex:/[a-zA-Z]/'],
            'excerpt_ar' => ['required', 'string', 'min:50', 'max:500', 'regex:/[\x{0600}-\x{06FF}]/u'],
            'excerpt_en' => ['required', 'string', 'min:50', 'max:500', 'regex:/[a-zA-Z]/'],
            'content_ar' => ['required', 'string', 'min:100', 'regex:/[\x{0600}-\x{06FF}]/u'],
            'content_en' => ['required', 'string', 'min:100', 'regex:/[a-zA-Z]/'],
